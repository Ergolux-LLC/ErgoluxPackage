...
class RideLexer(RegexLexer):
    ...
    typesName = (
        ...
        'Transfer', 'AssetPair', 'DataEntry', 'Order', '{{ table_name|capitalize }}',
        'Genesis{{ table_name|capitalize }}', 'Payment{{ table_name|capitalize }}', 'Reissue{{ table_name|capitalize }}',
        'Burn{{ table_name|capitalize }}', 'MassTransfer{{ table_name|capitalize }}', 'Exchange{{ table_name|capitalize }}',
        'Transfer{{ table_name|capitalize }}', 'SetAssetScript{{ table_name|capitalize }}',
        'InvokeScript{{ table_name|capitalize }}', 'Issue{{ table_name|capitalize }}', 'Lease{{ table_name|capitalize }}',
        'LeaseCancel{{ table_name|capitalize }}', 'CreateAlias{{ table_name|capitalize }}',
        'SetScript{{ table_name|capitalize }}', 'SponsorFee{{ table_name|capitalize }}', 'Data{{ table_name|capitalize }}',
    ...
    functionsName = (
        ...
        'fromBase64String', '{{ table_name }}ById', '{{ table_name }}HeightById',
        ...
        'transfer{{ table_name|capitalize }}ById',
    )
